...
import 'package:three_dart_v2/three3d/renderers/web_gl_render_target.dart';
import 'package:three_dart_v2/three3d/renderers/webgl/index.dart';
import 'package:three_dart_v2/three3d/renderers/webxr/web_xr_manager.dart';
import 'package:three_dart_v2/three3d/scenes/index.dart';
import 'package:three_dart_v2/three3d/textures/index.dart';
import 'package:three_dart_v2/extra/console.dart';
...
class WebGLRenderer {
  ...
  WebGLRenderer(Map<String, dynamic>? parameters) {
    ...
    _width = this.parameters["width"]?.toDouble() ?? 0.0;
    _height = this.parameters["height"]?.toDouble() ?? 0.0;
  ...
  void renderBufferDirect(
    ...
    if (material.uniformsGroups != null) {
      var uniformsGroupsList = material.uniformsGroups!;

      for (var i = 0, l = uniformsGroupsList.length; i < l; i++) {
        var uniformsGroup = uniformsGroupsList[i];

        uniformsGroups.update(uniformsGroup, program);
        uniformsGroups.bind(uniformsGroup, program);
      }
    }
