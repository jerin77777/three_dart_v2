...
class WebGLState {
  ...
  var uboBindings = WeakMap();
  var uboProgramMap = WeakMap();
  ...
  void updateUBOMapping(uniformsGroup, program) {
  ...
  void uniformBlockBinding(uniformsGroup, program) {
    ...
    if (uboBindings.get(program) != blockIndex) {
      ...
      gl.uniformBlockBinding(program, blockIndex, uniformsGroup.bindingPointIndex);
